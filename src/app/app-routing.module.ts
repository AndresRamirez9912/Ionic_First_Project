...
const routes: Routes = [
  ...
  {
    path: 'inifinite-scroll',
    loadChildren: () => import('./pages/inifinite-scroll/inifinite-scroll.module').then( m => m.InifiniteScrollPageModule)
  },
  {
    path: 'input',
  ...
  {
    path: 'ionic-list',
    loadChildren: () => import('./pages/ionic-list/ionic-list.module').then( m => m.IonicListPageModule)
  },
  {
    path: 'list-reorder',
